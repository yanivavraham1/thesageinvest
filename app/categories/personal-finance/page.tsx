...
export default async function PensionAndPersonalFinance() {
  try {
    const posts = await getPostsByCategory(13);

    console.log("Posts data:", posts); // Add this for debugging

    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <h1 className="text-3xl font-bold mb-6">מאמרים על התנהלות כלכלית</h1>
    ...
    console.error("Error in PensionAndPersonalFinance:", error);
    return (
